...
pyastar_contour.astar.restype = ndmat_i2_type  # Nx2 (i, j) coordinates or None
pyastar_contour.astar.argtypes = [
...
def astar_path(
    ...
    path = pyastar_contour.astar.astar(
